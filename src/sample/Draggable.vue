...
import { ref, computed as $computed  } from 'vue'
import dynamics from 'dynamics.js'

const $ref = (val) => val.value
...
<template>
    <div class="draggable" @mousedown="startDrag" @touchstart="startDrag" @mousemove="onDrag" @touchmove="onDrag"
